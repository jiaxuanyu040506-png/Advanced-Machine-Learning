...
from REINFORCE import create_network as createReinforceNetwork
...
def main():
    ...
    net = createReinforceNetwork()
    load_checkpoint(sess, CHECKPOINT_DIR, CHECKPOINT_PREFIX, CHECKPOINT_STEP)
    rewards = evaluate_model(sess, net['s_ph'], net['probs'], game.GameState)
    sess.close()
