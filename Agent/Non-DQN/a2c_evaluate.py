...
from A2C_1 import createA2CNetwork

# ---------------- Config ----------------
NUM_EVAL_EPISODES = 20
MAX_EPISODE_STEPS = 10000

CHECKPOINT_DIR = "saved_networks/a2c_1"
CHECKPOINT_PREFIX = "bird-a2c"
...
def main():
    ...
    s_ph, logits, policy, value = createA2CNetwork()
    load_checkpoint(sess, CHECKPOINT_DIR, CHECKPOINT_PREFIX, CHECKPOINT_STEP)
    rewards = evaluate_model(sess, s_ph, policy, game.GameState)
    sess.close()
